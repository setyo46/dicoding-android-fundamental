package com.setyo.mynoteapps.adapter

import android.view.LayoutInflater
import android.view.View
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.setyo.mynoteapps.R
import com.setyo.mynoteapps.databinding.ItemNoteBinding
...
class NoteAdapter(private val onItemClickCallback: OnItemClickCallback): RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() {
    ...
    interface OnItemClickCallback {
        fun onItemClicked(selectNote: Note?, position: Int?)
    }
